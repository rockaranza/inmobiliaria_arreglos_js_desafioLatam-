...
//Llamado a funcion para crear contenido
crearTarjetas(propiedades_venta, 'contenedor-ventas');
crearTarjetas(propiedades_alquiler, 'contenedor-alquileres')


function crearTarjetas(propiedades, idEtiqueta) {
    // Iterar sobre el arreglo propiedades y entrega los primeros tres valores
    propiedades.slice(0, 3).forEach(function(propiedad, index) {
    // Obtener el contenedor donde se insertará la tarjeta
    const contenedor = document.getElementById(idEtiqueta); // Asegúrate de tener un elemento con el ID "contenedor-tarjetas" en tu HTML
